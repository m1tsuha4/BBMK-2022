...
class Participant extends CI_Model
{
    ...
    public function get_participant_all_year()
    {
        ...
        count(if(peserta.tahun=2022,1,null)) as 'y22',
        count(if(peserta.tahun=2021,1,null)) as 'y21',
        count(if(peserta.tahun is null,1,null)) as 'y20',

        count(if(peserta.stat_reg = 1 AND peserta.tahun =2022,1,null)) as 'verif22',
        count(if(peserta.stat_reg = 2 AND peserta.tahun =2022,1,null)) as 'not_verif22',
        count(if(peserta.stat_reg = 0 AND peserta.tahun =2022 ,1,null)) as 'nverif22',
        count(if(peserta.kelulusan = 1 AND peserta.tahun =2022,1,null)) as 'pass22',
        count(if(peserta.kelulusan = 2 AND peserta.tahun =2022 ,1,null)) as 'not_pass22',
        count(if(peserta.kelulusan = 0 AND peserta.tahun =2022,1,null)) as 'npass22',
