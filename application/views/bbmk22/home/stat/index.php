...
$peserta_22_lk = $this->db->query("SELECT* FROM peserta WHERE jk='Laki - Laki' AND tahun ='2022'")->num_rows();
$peserta_22_p = $this->db->query("SELECT* FROM peserta WHERE jk='Perempuan' AND tahun ='2022'")->num_rows();
?>
        ...
        data: {
            ...
            datasets: [{
                    ...
                    data: [
                        ...
                        $no_ukm = 1;
                        foreach ($query->result() as $ukm) {
                            $peserta = $this->db->query("SELECT* FROM peserta WHERE id_ukm = $ukm->id AND tahun = 2022 AND kelulusan=1");
                            echo ($peserta->num_rows() . ',');
                        }
                        ?>
                    ]
        ...
        data: {
            ...
            datasets: [{
                    ...
                    data: [
                        ...
                        $no_ukm = 1;
                        foreach ($query->result() as $ukm) {
                            $peserta = $this->db->query("SELECT* FROM peserta WHERE id_ukm = $ukm->id AND tahun = 2022 AND kelulusan=2");
                            echo ($peserta->num_rows() . ',');
                        }
                        ?>
                    ]
        ...
        data: {
            ...
            datasets: [{
                    ...
                    data: [
                        ...
                        $no_ukm = 1;
                        foreach ($query->result() as $ukm) {
                            $peserta = $this->db->query("SELECT* FROM peserta WHERE id_ukm = $ukm->id AND tahun = 2022 AND kelulusan = 0");
                            echo ($peserta->num_rows() . ',');
                        }
                        ?>
                    ]
