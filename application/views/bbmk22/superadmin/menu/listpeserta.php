    ...
    <li class="list-group-item bg-light">
        <h3 class="text-info">
            <div class="list-group">
                <a href="<?= base_url() ?>superadmin22/listpeserta/2020" class="list-group-item list-group-item-action <?= $tahun_2020 ?>" aria-current="true">
                    Peserta BBMK 2020
                </a>
                <a href="<?= base_url() ?>superadmin22/listpeserta/2021" class="list-group-item list-group-item-action <?= $tahun_2021 ?>">Peserta BBMK 2021</a>
                <a href="<?= base_url() ?>superadmin22/listpeserta/2022" class="list-group-item list-group-item-action <?= $tahun_2022 ?>">Peserta BBMK 2022</a>
            </div>
        </h3>
    </li>
    <!-- DataTales Example -->
