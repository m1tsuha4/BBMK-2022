...
$jumlah_peserta22 = $this->db->query("SELECT* FROM peserta WHERE tahun ='2022'")->num_rows();
$jumlah_verif22 = $this->db->query("SELECT* FROM peserta WHERE stat_reg= 1 AND tahun ='2022'")->num_rows();
$jumlah_nonverif22 = $this->db->query("SELECT* FROM peserta WHERE stat_reg= 2 AND tahun ='2022'")->num_rows();
$jumlah_belumverif22 = $this->db->query("SELECT* FROM peserta WHERE stat_reg= 0 AND tahun ='2022'")->num_rows();


$jumlah_lulus22 = $this->db->query("SELECT* FROM peserta WHERE kelulusan= 1 AND tahun ='2022'")->num_rows();
$jumlah_tidaklulus22 = $this->db->query("SELECT* FROM peserta WHERE kelulusan= 2 AND tahun ='2022'")->num_rows();
$jumlah_belumlulus22 = $this->db->query("SELECT* FROM peserta WHERE kelulusan= 0 AND tahun ='2022'")->num_rows();
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Statistik 2022</h1>
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_peserta22 ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_verif22 ?></div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col-auto">
                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $jumlah_nonverif22 ?></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-auto">
                ...
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            ...
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_belumverif22 ?></div>
                        </div>
                        <div class="col-auto">
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-5">
                        <canvas id="verifChart22" width="800" height="750"></canvas>
                    </div>
...
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Statistik 2021</h1>
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-xl-4 col-lg-5">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <div class="chart-pie pt-4 pb-5">
                        <canvas id="verifChart21" width="800" height="750"></canvas>
                    </div>
...
<div class="container-fluid">
    <!-- Page Heading -->
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Statistik 2020</h1>
        <a href="#" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Report</a>
    </div>
            ...
            <div class="card border-left-danger shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        <div class="col mr-2">
                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">On Process</div>
                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlah_belumverif20 ?></div>
                        </div>
                        <div class="col-auto">
                            <i class="fas fa-user-clock fa-2x text-gray-300"></i>
                        </div>
...
<script>
    // 2022
    new Chart(document.getElementById("verifChart22"), {
        type: 'doughnut',
        data: {
            ...
            datasets: [{
                ...
                data: [
                    <?php
                    echo ($jumlah_verif22 . ',');
                    echo ($jumlah_belumverif22 . ',');
                    echo ($jumlah_nonverif22 . ',');
    ...
    // kelulusan
    new Chart(document.getElementById("passChart22"), {
        type: 'doughnut',
        data: {
    ...
    // 2021
    new Chart(document.getElementById("verifChart21"), {
        type: 'doughnut',
        data: {
            labels: ["Verificated", "On Process", "Unverified"],
            datasets: [{
    ...
    // kelulusan
    new Chart(document.getElementById("passChart21"), {
        type: 'doughnut',
        data: {
            labels: ["Pass", "Not Pass", "Process"],
            datasets: [{
