<div class="content-wrapper">
    <section class="content">
        <div class="container-fluid">
            ...
            <h3>Statstik Peserta <a class="btn btn-info" href="<?= base_url() ?>superadmin22/downloadpeserta">Download Excel</a> </h3>
            <!-- verifikasi -->
            <div class="row">
                <div class="col-md-12">
                    <!-- Bar chart -->
            ...
            <!-- Jurusan -->
            <h3>Jurusan <a class="btn btn-info" href="<?= base_url() ?>superadmin22/downloadjurusan">Download Excel</a> </h3>
            <?php
            $query = $this->db->query("SELECT * FROM fakultas");
            $no_ukm = 1;
            foreach ($query->result() as $ukm) {
