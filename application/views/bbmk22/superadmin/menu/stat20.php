...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url() ?>superadmin22/downloadpeserta20" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate All Participant</a>
        <a href="<?= base_url() ?>superadmin22/downloadukm20" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate UKM</a>
        <a href="<?= base_url() ?>superadmin22/downloadfakultas20" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Faculty</a>
        <a href="<?= base_url() ?>superadmin22/downloadjurusan20" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Major</a>
    </div>
