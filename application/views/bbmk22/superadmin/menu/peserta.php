...
if ($tahun == 2020) {
    ...
    $tahun_2020 = "";
    $tahun_kirim = 2022;
    $nquery = $this->db->query("SELECT * FROM peserta WHERE tahun = 2022  LIMIT  $limitStart,$limit");
    $nquery2 = $this->db->query("SELECT * FROM peserta WHERE tahun = 2022");
} else {
    $tahun_2022 = "";
    $tahun_2021 = "";
    $tahun_2020 = "";
    ...
    <section class="content">
        <div class="container-fluid">
                ...
                <li class="list-group-item bg-light">
                    <h3 class="text-info">
                        <div class="list-group">
                            <a href="<?= base_url() ?>superadmin22/peserta/2020" class="list-group-item list-group-item-action <?= $tahun_2020 ?>" aria-current="true">
                                Peserta BBMK 2020
                            </a>
                            <a href="<?= base_url() ?>superadmin22/peserta/2021" class="list-group-item list-group-item-action <?= $tahun_2021 ?>">Peserta BBMK 2021</a>
                            <a href="<?= base_url() ?>superadmin22/peserta/2022" class="list-group-item list-group-item-action <?= $tahun_2022 ?>">Peserta BBMK 2022</a>
                        </div>
                    </h3>
                </li>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    if (isset($_POST["reset$uid"])) {
                                        $new = password_hash("bbmk2022", PASSWORD_DEFAULT);
            ...
            <ul class="pagination flex-wrap">
                ...
                ?>
                    <li class="page-item <?= $stat ?>"><a class="page-link" href="<?= base_url() ?>superadmin22/peserta/<?= $tahun_kirim ?>/<?= $i ?>"><?= $i ?></a></li>
