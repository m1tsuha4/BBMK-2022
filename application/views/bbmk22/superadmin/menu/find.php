                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                if (isset($_POST["hapus$uid"])) {
                                    ...
                                    if ($delete) {
                                        ...
                                        if ($update) {
                                            $this->alert->pesan("success", "Berhasil...", "Peserta berhasil dihapus", 1, base_url("/superadmin22/home"));
                                        } else {
                            ...
                            <td>
                                ...
                                if (isset($_POST["reset$uid"])) {
                                    ...
                                    if ($update) {
                                        $this->alert->pesan("success", "Berhasil...", "Password peserta berhasil direset", base_url("/superadmin22/home"));
                                    } else {
                                        $this->alert->pesan("error", "Gagal...");
                                    }
                                } ?>
