...
$jumlah_peserta21 = $this->db->query("SELECT* FROM peserta WHERE tahun ='2022'")->num_rows();
$jumlah_verif21 = $this->db->query("SELECT* FROM peserta WHERE stat_reg= 1 AND tahun ='2022'")->num_rows();
$jumlah_nonverif21 = $this->db->query("SELECT* FROM peserta WHERE stat_reg= 2 AND tahun ='2022'")->num_rows();
$jumlah_belumverif21 = $this->db->query("SELECT* FROM peserta WHERE stat_reg= 0 AND tahun ='2022'")->num_rows();


$jumlah_lulus21 = $this->db->query("SELECT* FROM peserta WHERE kelulusan= 1 AND tahun ='2022'")->num_rows();
$jumlah_tidaklulus21 = $this->db->query("SELECT* FROM peserta WHERE kelulusan= 2 AND tahun ='2022'")->num_rows();
$jumlah_belumlulus21 = $this->db->query("SELECT* FROM peserta WHERE kelulusan= 0 AND tahun ='2022'")->num_rows();
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="<?= base_url() ?>superadmin22/downloadpeserta22" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate All Participant</a>
        <a href="<?= base_url() ?>superadmin22/downloadukm22" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate UKM</a>
        <a href="<?= base_url() ?>superadmin22/downloadfakultas22" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Faculty</a>
        <a href="<?= base_url() ?>superadmin22/downloadjurusan22" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Major</a>
    </div>
    ...
    <div class="row">
        ...
        foreach ($query->result() as $ukm) {
            ...
            $peserta = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND tahun ='2022'");
            $pesertaverif = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND stat_reg= 1 AND tahun ='2022'");
            $pesertanonverif = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND stat_reg= 2 AND tahun ='2022'");
            $pesertabelumverif = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND stat_reg= 0 AND tahun ='2022'");

            $pesertalulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND kelulusan= 1 AND tahun ='2022'");
            $pesertatidaklulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND kelulusan= 2 AND tahun ='2022'");
            $pesertabelumlulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm ='$ukm->id' AND kelulusan= 0 AND tahun ='2022'");
                        ...
                        <div class="card-body">
                            ...
                            <table class="table table-borderless" style="width: 60%; margin-left: auto; margin-right: auto">
                                ...
                                <tr>
                                    ...
                                    <td2>:</td2 <td><?= $pesertabelumverif->num_rows() ?></td>
                                </tr>
                                <tr>
        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                foreach ($query->result() as $ukm) {
                    ...
                    $pesertaverif = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND stat_reg= 1 AND tahun ='2022'");
                    $pesertanonverif = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND stat_reg= 2 AND tahun ='2022'");
                    $pesertabelumverif = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND stat_reg= 0 AND tahun ='2022'");

                    $pesertalulus = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND kelulusan= 1 AND tahun ='2022'");
                    $pesertatidaklulus = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND kelulusan= 2 AND tahun ='2022'");
                    $pesertabelumlulus = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND kelulusan= 0 AND tahun ='2022'");
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    foreach ($jquery->result() as $j) {
                        $peserta = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND tahun ='2022'");
                        $pesertaverif = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND stat_reg= 1 AND tahun ='2022'");
                        $pesertanonverif = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND stat_reg= 2 AND tahun ='2022'");
                        $pesertabelumverif = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND stat_reg= 0 AND tahun ='2022'");

                        $pesertalulus = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND kelulusan= 1 AND tahun ='2022'");
                        $pesertatidaklulus = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND kelulusan= 2 AND tahun ='2022'");
                        $pesertabelumlulus = $this->db->query("SELECT* FROM peserta WHERE jurusan ='$j->id' AND kelulusan= 0 AND tahun ='2022'");
