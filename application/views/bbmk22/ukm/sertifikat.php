...
$query = $this->db->query("SELECT * FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022' AND stat_reg = '1' HAVING kelulusan = 1 OR kelulusan = 0");
?>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            if ($key->sertifikat) {
                            ?>
                                <a href="<?= base_url() ?>admin22/downloadsertif/<?= $key->id ?>/<?= $key->id_ukm ?>/<?= $key->sertifikat ?>">
