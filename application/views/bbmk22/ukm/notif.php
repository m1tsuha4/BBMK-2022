...
<div class="container-fluid">
    ...
    <div class="col-md-6 offset-md-3 text-center">
        <div class="pemberitahuan">
            <form action="" method="post">
                ...
                <input type="submit" value="kirim" class="btn btn-primary btn-edit px-3 mt-5 mb-5" name="kirim">
            </form>
        </div>
    </div>
    ...
    <?php
        ...
        if (isset($_POST["delete$ukm->id"])) {
            ...
            if ($update) {
                $this->alert->msg("success", "Berhasil...", "Delete berhasil  ", 1, base_url("/admin22/notif"));
            } else {
...
if (isset($_POST["kirim"])) {
    ...
    if ($kirim) {
        $this->alert->msg("success", "Pemberitahuan akan dikirimkan ke peserta...", "", 1, base_url("/admin22/notif"));
    } else if (@$kirim == "gagal") {
