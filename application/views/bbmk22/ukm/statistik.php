...
<?php
$jumlah_peserta = $this->db->query("SELECT * FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022'");
$jumlah_verif = $this->db->query("SELECT * FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022'AND stat_reg='1' ");
$jumlah_nonverif = $this->db->query("SELECT * FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022'AND stat_reg='2' ");
$jumlah_belumverif = $this->db->query("SELECT * FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022'AND stat_reg='0' ");


$jumlah_lulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022' AND kelulusan= 1");
$jumlah_tidaklulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022' AND kelulusan= 2");
$jumlah_belumlulus = $this->db->query("SELECT* FROM peserta WHERE id_ukm = '$ss' AND tahun = '2022'AND kelulusan= 0");
?>
<div class="container-fluid">
    <h1 class="h3 mb-3 mt-3 text-gray-800">Statistik BBMK 2022</h1>
            ...
            <div class="container-fluid">
                ...
                <div class="row mt-5">
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        ...
                        <a href="<?= base_url() ?>admin22/downloadpeserta" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate All Participant</a>
                        <a href="<?= base_url() ?>admin22/downloadkehadiran" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Present</a>
                        <a href="<?= base_url() ?>admin22/downloadkelulusan" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Generate Pass Participant</a>
            ...
            data: {
                ...
                datasets: [{
                    ...
                    data: [
                        ...
                        $no_ukm = 1;
                        foreach ($query->result() as $ukm) {
                            $peserta = $this->db->query("SELECT* FROM peserta WHERE fakultas ='$ukm->id' AND id_ukm = '$ss' AND tahun = '2022'");
